    ...
    <div class="row">
      ...
      <div class="col-sm-5 col-md-5 portfolio-block">
        ...
        <ul class="project-general-info">
          ...
          <li><p><i class="fa fa-address-card"></i>Nama Resmi Produk: 2017 - TOYOTA - CALYA 1.2 G</p></li>
          <li><p><i class="fa fa-money"></i>Harga: Rp 135.000.000</p></li>
          <li><p><i class="fa fa-car"></i>Kategori: Mobil Toyota</p></li>
        ...
        <input type="button" class="button btn-send" value="Beli Kredit" onclick="window.location.href='page_pembayaran-credit-3.php'">
        </form>
